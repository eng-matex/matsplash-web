  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const mockProducts: Product[] = [
        {
          id: 1,
          name: 'Water Sachets (500ml)',
          description: 'Pure water sachets, 500ml each',
          category: 'Water Sachets',
          unit: 'bag',
          base_cost: 100,
          current_price: 150,
          previous_price: 140,
        ...
        {
          id: 2,
          name: 'Water Sachets (1L)',
          description: 'Pure water sachets, 1 liter each',
          category: 'Water Sachets',
          unit: 'bag',
          base_cost: 180,
          current_price: 250,
