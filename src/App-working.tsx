          ...
          >
            ...
            <List sx={{ flexGrow: 1, overflowY: 'auto' }}>
              <ListItem disablePadding>
                ...
                >
                  <ListItemIcon sx={{ color: currentPage === 'overview' ? theme.palette.primary.contrastText : theme.palette.primary.main }}>
                    <Email />
                  </ListItemIcon>
                  <ListItemText primary="Overview" sx={{ color: currentPage === 'overview' ? theme.palette.primary.contrastText : theme.palette.text.primary }} />
                </ListItemButton>
              </ListItem>
            </List>
            ...
            <Card sx={{ p: 3 }}>
              <CardContent>
                ...
                <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
                  Working version - Application is functioning correctly!
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  This is a simplified version that works. We'll gradually add back the full functionality.
                </Typography>
              </CardContent>
            </Card>
          </Box>
